...
class StudentDtoTest {
    ...
    void testToJson() {
        final StudentDto dto = StudentDto.builder()
            ...
            .putAllScores(Collections.emptyMap())
            .addAllEmails(Collections.emptyList())
            .setAdditionalInt(1000)
            .addAllAdditionalList(ImmutableList.of("12", "345", "789"))
            .putAllAdditionalMap(ImmutableMap.of("k1", 345, "k2", 789))
            .build();

        final String str = JsonbBuilder.create().toJson(dto, StudentDto.class);
